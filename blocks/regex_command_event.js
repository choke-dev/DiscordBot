module.exports = {
    name: "Regex Command [Event]",

    description: "When regex is detected this event will trigger.",
    ...
    inputs: [
        {
            "id": "command_name",
            "name": "Regex Code",
            "description": "Acceptable Types: Text, Unspecified\n\nDescription: Regex for the trigger. Example: !h(i|ello) or (!hi|!hello)",
    ...
    code(cache) {
        ...
        this.events.on("message", msg => {
			...
			let regexcd = "/" + command_name + prefix

            if(!this.ConvertRegex(regexcd).test(content)) return;
